...
NR % 1000 == 0 {
    print (tp_fam+fp ? tp_fam/(tp_fam+fp) : 1), 
          (tp_sfam+fp ? tp_sfam/(tp_sfam+fp) : 1), 
          (tp_fold+fp ? tp_fold/(tp_fold+fp) : 1), 
          (queries ? tp_fam/queries : 0), 
          (queries ? tp_sfam/queries : 0), 
          (queries ? tp_fold/queries : 0)
}									       
