...
NR %2000 == 0 && (tp_fam+fp)>0 && (tp_sfam+fp)>0 && (tp_fold+fp)>0{ print tp_fam/(tp_fam+fp), tp_sfam/(tp_sfam+fp), tp_fold/(tp_fold+fp), tp_fam / queries, tp_sfam / queries, tp_fold / queries, tp_fam; }										       
